...
function useEventCreate() {
  const initialForm = {
    name: "wweewe",
    slug: "ewewe",
    organised_by: "64fa994d6ebb77d9078b14b2",
    start_date: "12/10/2024",
    end_date: "12/11/2024",
    location: "ewewewr",
    admin_id: "64f9765141c259ff1c7c67da",
    url: "https://www.youtube.com/",
    registration_url: "https://www.youtube.com/",
    registration_status: "YES",
    is_digital: "YES",
    related_event_ids: [],
    description: "fsdfdssdf",
    logo: "",
    thumbnail: "",
    banner: "",
    primary_colour: "#FFAABB",
    secondary_colour: "#FFAABB",
    action_colour: "#FFAABB",
    menu_text_colour: "#FFAABB",
    all: false,
    event_participants: false,
    chapters: false,
    accessible_chapter_ids: [],
    is_gallery_public: "YES",
  };
  const featureKey = {
